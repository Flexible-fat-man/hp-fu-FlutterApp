...
class MerchantDetails extends StatefulWidget {
  final Device dateBean;

  MerchantDetails({Key key, @required this.dateBean}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _MerchantDetailsState(dateBean: dateBean);
  }
}
...
class _MerchantDetailsState extends State<MerchantDetails> {
  ...
  _MerchantDetailsState({this.dateBean});
  ...
  void _initData() {
    print('deviceNo');
    print(dateBean.deviceNo);
    HttpManager().post(
      url: ApiHelper.deviceFind,
      data: {"containType": '7', 'deviceNo': dateBean.deviceNo},
