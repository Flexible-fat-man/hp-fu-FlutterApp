...
class PurchaseYsbDevicePage extends StatefulWidget {
  @override
  _PurchaseYsbDevicePageState createState() => _PurchaseYsbDevicePageState();
}

class _PurchaseYsbDevicePageState extends State<PurchaseYsbDevicePage> {
  void onLogin() async {
