...
class DateUtil {
  ...
  /// get Now Date Str.(yyyyMMdd)
  static String getNowDateStr2() {
    return getDateStrByDateTime2(DateTime.now());
  }

  /// get Now Date Str.(yyyy-MM-dd)
  static String getNowDateStr3() {
    return getDateStrByDateTime3(DateTime.now());
  }

  /// get 上月 Date Str.(yyyyMM)
  static String getNowDateStr4() {
    return getDateStrByDateTime4(DateTime.now());
  }

  /// get Now Date Str.(yyyy-MM)
  static String getNowDateStr5() {
    return getDateStrByDateTime5(DateTime.now());
  }

  /// get Now Date Str.(yyyy-MM-dd HH:mm:ss)
  static String getDateStr(String dateStr, String timeStr) {
    if (dateStr == null ||
        timeStr == null ||
        dateStr.length != 8 ||
        timeStr.length != 6) {
    ...
    String dateTime = "";
    if (dateStr.isNotEmpty && dateStr.isNotEmpty) {
      dateTime = dateStr.substring(0, 4) +
          "-" +
  ...
  /// dateSeparate    date separate.
  /// timeSeparate    time separate.
  static String getDateStrByDateTime2(DateTime dateTime,
  ...
  /// dateSeparate    date separate.
  /// timeSeparate    time separate.
  static String getDateStrByDateTime3(DateTime dateTime,
      {DateFormat format = DateFormat.YEAR_MONTH_DAY,
      String dateSeparate,
      String timeSeparate}) {
    if (dateTime == null) return null;
  ...
  static String getDateStrByDateTime4(DateTime dateTime,
      {DateFormat format = DateFormat.YEAR_MONTH,
      String dateSeparate,
      String timeSeparate}) {
    if (dateTime == null) return null;
  ...
  static String getDateStrByDateTime5(DateTime dateTime,
      {DateFormat format = DateFormat.YEAR_MONTH,
      String dateSeparate,
      String timeSeparate}) {
    if (dateTime == null) return null;
